...
function ReadableStream(emitter, options) {
	...
	self.reader = (generic = generic || require('./devices/generic')).reader(readChunk);
}
...
HttpClientRequest.prototype.setTimeout = function(ms, _) {
	this.emitter.setTimeout(ms, ~_);
	return this;
}
